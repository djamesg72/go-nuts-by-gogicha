...
const MyComponent = class {
    constructor(hostRef) {
        ...
        this.gamePaused = index.createEvent(this, "gamePaused", 7);
        this.gameOver = index.createEvent(this, "gameOver", 7);
        this.gameWon = index.createEvent(this, "gameWon", 7);
        this.devMode = false;
        this.paused = false;
        /**
         * for dev-mode
    ...
    render() {
        return (index.h(index.Host, { class: "game-container" }, index.h("div", { class: "game-container-left" }, index.h("nav-button", { direction: "left-top" }), index.h("nav-button", { direction: "left-bottom" })), index.h("div", { class: "game-container-center" }, index.h("div", { class: "console" }), index.h("div", { class: "border" }, index.h("div", { class: "border-left" }), index.h("div", { class: "border-center" }, index.h("div", { class: "title" }, "Go Nuts for Gogicha")), index.h("div", { class: "border-right" })), index.h("div", { class: "screen" }, index.h("div", { class: "score" }, String(this.score).padStart(3, '0'), " "), index.h("div", { class: "lose", ref: (el) => this.loseContainer = el }), this.isGameOver && index.h("div", { class: "game-over" }, "\u10E8\u10D4\u10DC \u10DB\u10D4\u10D8\u10E1\u10DE\u10D4"), this.isWon && index.h("div", { class: "game-won" }, "YOU WON"), index.h("div", { class: this.showRabbit ? 'rabbit' : '' }), index.h("g-wolf", { ref: (el) => this.wolf = el }), index.h("div", { class: "eggs-container", ref: (el) => this.eggsContainer = el }))), index.h("div", { class: "clearfix" }), index.h("div", { class: "game-container-right" }, index.h("div", { class: "button-container" }, index.h("button", { class: "mode-button", onClick: this.startGame.bind(this, true) }, "Start"), this.devMode && this.gameStarted &&
            index.h("button", { class: "mode-button", onClick: this.pauseGame.bind(this) }, " ", this.paused ? 'Continue' : 'Pause', " ")), index.h("nav-button", { direction: "right-top" }), index.h("nav-button", { direction: "right-bottom" }))));
    }
...
const MyComponent$1 = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.eggIsCathced = index.createEvent(this, "eggIsCathced", 7);
        this.eggMoveDuration = 1000;
        this.step = 1;
    ...
    render() {
        return (index.h(index.Host, null, index.h("div", { class: "egg", style: this.stepStyleObject[this.step] }), index.h("div", { class: "bird-container" }, index.h("div", { class: `bird ${this.birdIsShown ? `bird-${this.xSide}` : ''}` }))));
    }
...
const MyComponent$2 = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.wolfDirectionChange = index.createEvent(this, "wolfDirectionChange", 7);
    ...
    render() {
        return (index.h("div", { class: this.position }));
    }
    static get watchers() { return {
...
const MyComponent$3 = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.gChooseDirection = index.createEvent(this, "gChooseDirection", 7);
    }
    chooseDirection() {
    ...
    render() {
        return (index.h(index.Host, { class: this.direction, onClick: this.chooseDirection.bind(this) }, index.h("button", null), index.h("div", { class: "nav-container" }, index.h("div", { class: "nav" }))));
    }
};
MyComponent$3.style = buttonCss;

exports.g_app = MyComponent;
exports.g_egg = MyComponent$1;
exports.g_wolf = MyComponent$2;
exports.nav_button = MyComponent$3;
